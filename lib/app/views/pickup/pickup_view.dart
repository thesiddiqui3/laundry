...
class _RequestPickupScreenState extends State<RequestPickupScreen> {
  ...
  Future<void> _handleSubmit() async {
    if (_formKey.currentState!.validate() && clothesCount > 0) {
      try {
        ...
        // Generate a unique order ID (alpha-numeric)
  ...
  String _generateOrderId() {
    // Generate a UUID and take the first 8 characters for a shorter ID
    // You can customize this as needed
    String uuid = _uuid.v4();
    return 'ORD-${uuid.substring(0, 8).toUpperCase()}';
    
    // Alternative: If you want incremental-like IDs but unique across users
